...
.. code-block:: python
    ...
    picnic = PicnicAPI(username='username', password='password', store=False)


You can also store your credentials by setting the store value to true, this will store your credentials in /config/app.yaml
